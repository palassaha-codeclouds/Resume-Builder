    ...
    return (
        <div className="space-y-5">
            <div>
                ...
                <p className="text-sm text-gray-500">Add your professional skills below.</p>
            </div>
            ...
            <div className="bg-green-50 p-3 rounded-lg border border-green-100">
                <p className="text-sm text-green-800">
                    <strong>Tip:</strong> Add relevant skills that highlight your expertise and
                    strengths. This helps potential employers or collaborators understand your
                    capabilities better.
                </p>
            </div>
        </div>
