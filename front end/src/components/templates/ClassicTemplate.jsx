        ...
        <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-600">
          {personal_info.email && (
            <div className="flex items-center gap-1">
              ...
              <span className="icon-text">{personal_info.email}</span>
            </div>
          )}
          {personal_info.phone && (
            <div className="flex items-center gap-1">
              <Phone className="size-4" />
              <span className="icon-text">{personal_info.phone}</span>
            </div>
          )}
          {personal_info.location && (
            <div className="flex items-center gap-1">
              <MapPin className="size-4" />
              <span className="icon-text">{personal_info.location}</span>
            </div>
          )}
          {personal_info.linkedin && (
            <div className="flex items-center gap-1">
              <Linkedin className="size-4" />
              <span className="break-all icon-text">
                {personal_info.linkedin}
              </span>
            </div>
          )}
